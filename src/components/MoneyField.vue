...
// ⚠ Вторая половина той же беды. Оверлей шторки встаёт над клавиатурой
// целиком, но само поле может стоять в её прокручиваемой части — и тогда оно
// уезжает вниз внутри шторки, а не вместе с ней. Поэтому после фокуса поле
