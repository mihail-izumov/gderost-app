...
// категории под ней. Вынесен из входа отдельным компонентом, потому что
// у него появился второй адрес — страница «Ультра». Две копии одной вёрстки
// разошлись бы молча: кегль, интерлиньяж и разгонка подобраны вместе,
// и правка в одном месте обязана доезжать до второго.
//
